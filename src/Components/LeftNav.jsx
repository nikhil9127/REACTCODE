    ...
    return (
        <>
            <div className="list-group">
                <p className="background text-light p-2 mb-2 mt-3" aria-current="true"> Main-Category</p>  
            ...
            <div className="list-group">
                <p className="background text-light p-2 mb-2" aria-current="true">Sub-Category </p>
                ...
                <div className="list-group">
                <p  className=" background text-light p-2 mb-2" aria-current="true">Brand</p>
